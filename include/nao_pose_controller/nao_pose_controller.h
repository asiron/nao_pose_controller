    ...
    namespace NaoControllers {
      ...
      public:
        ...
        private:
          ...
          void publishPoseToRviz(const geometry_msgs::PoseStamped& pose)const;

          // Helpers
          geometry_msgs::Pose2D TFPoseToPose2D(tf::Transform tf_pose) const;
          bool isGoalWithinTresholdOf(const Treshold& treshold, const geometry_msgs::Pose2D& goal) const;
          std::vector<geometry_msgs::PoseStamped> getDirectionSubgoal(const geometry_msgs::PoseStamped& next_goal) const;
